...
//
        ...
        val pendingIntent = PendingIntent.getActivity(context,
            i.getLongExtra("noteId",0).toInt(),i,PendingIntent.FLAG_IMMUTABLE or PendingIntent.FLAG_UPDATE_CURRENT)
...
//                .addAction(0, "ACTION",pendingIntent)
            ...
            manager.notify( i.getLongExtra("noteId",0).toInt(), notification)
    }
